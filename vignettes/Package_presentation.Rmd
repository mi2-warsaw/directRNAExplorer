...
```{r}
ksDistributionTest(datawt, databrm, "AT1G06760", genePart = "three_prime_UTR", strand="neg")
```
...
```{r, fig.width=7}
plotGeneComparisonDistribution("AT1G06680", datawt, databrm, genePart = "three_prime_UTR")
...
```{r, fig.width=7}
plotGeneComparisonDistribution("AT1G06680", datawt, databrm, genePart = "three_prime_UTR", stat="ecdf")
